...
public class Lua_NGUIText : LuaObject {
	...
	static public int Print_s(IntPtr l) {
		try {
			...
			checkType(l,3,out a3);
			BetterList<UnityEngine.Color> a4;
			checkType(l,4,out a4);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int InsertHyperlink_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			System.Int32 a2;
			...
			System.String a4;
			checkType(l,4,out a4);
			var ret=NGUIText.InsertHyperlink(ref a1,ref a2,a3,a4);
			pushValue(l,true);
			pushValue(l,ret);
			pushValue(l,a1);
			pushValue(l,a2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int ReplaceLinks_s(IntPtr l) {
		try {
			System.String a1;
			checkType(l,1,out a1);
			NGUIText.ReplaceLinks(ref a1);
			pushValue(l,true);
			pushValue(l,a1);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,ReplaceLink_s);
		addMember(l,InsertHyperlink_s);
		addMember(l,ReplaceLinks_s);
