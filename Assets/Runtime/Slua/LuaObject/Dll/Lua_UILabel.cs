...
public class Lua_UILabel : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_customModifier(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			UILabel.ModifierFunc v;
			int op=LuaDelegation.checkDelegate(l,2,out v);
			if(op==0) self.customModifier=v;
			else if(op==1) self.customModifier+=v;
			else if(op==2) self.customModifier-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_overflowWidth(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.overflowWidth);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int set_overflowWidth(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			int v;
			checkType(l,2,out v);
			self.overflowWidth=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_printedText(IntPtr l) {
		try {
			UILabel self=(UILabel)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.printedText);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"customModifier",null,set_customModifier,true);
		...
		addMember(l,"overflowWidth",get_overflowWidth,set_overflowWidth,true);
		...
		addMember(l,"printedText",get_printedText,null,true);
