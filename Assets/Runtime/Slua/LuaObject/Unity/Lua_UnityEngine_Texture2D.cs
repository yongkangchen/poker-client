	...
	static public int LoadImage(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Byte[] a1;
				checkArray(l,2,out a1);
				var ret=UnityEngine.ImageConversion.LoadImage(self, a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				System.Boolean a2;
				checkType(l,3,out a2);
				var ret=UnityEngine.ImageConversion.LoadImage(self, a1, a2);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public int EncodeToJPG(IntPtr l) {
		try {
			...
			if(argc==1){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				var ret=UnityEngine.ImageConversion.EncodeToJPG(self, a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
